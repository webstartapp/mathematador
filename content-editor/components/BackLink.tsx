...
// next/link (not a plain <a>, which every other *navigation* link in this
// tool uses - PagePreview.tsx's plain <a> is a deliberate exception, since
// it points at the real game app's own separate origin, not a route here)
// for a client-side transition.
