...
export const ChallengeStartNewParams = zod.object({
  operationId: zod.enum(["addition", "subtraction", "multiplication", "division+"]).describe("Tags to filter by")
});
...
export const ChallengeStartNewResponse = zod
  .object({
    operationId: zod.enum(["addition", "subtraction", "multiplication", "division"]).optional(),
    minigame: zod.enum(["singleLine", "dragAndDrop", "crossNumbers", "memory"]).optional(),
    userId: zod.uuid().optional(),
...
export const ChallengeGetAllResponse = zod
  .object({
    operationId: zod.enum(["addition", "subtraction", "multiplication", "division"]).optional(),
    minigame: zod.enum(["singleLine", "dragAndDrop", "crossNumbers", "memory"]).optional(),
    userId: zod.uuid().optional(),
...
export const ChallengeGetParams = zod.object({
  operationId: zod.enum(["addition", "subtraction", "multiplication", "division+"]).describe("Tags to filter by"),
  id: zod.uuid().describe("Unique identifier of a user registration")
});

export const ChallengeGetResponse = zod
  .object({
    operationId: zod.enum(["addition", "subtraction", "multiplication", "division"]).optional(),
    minigame: zod.enum(["singleLine", "dragAndDrop", "crossNumbers", "memory"]).optional(),
    userId: zod.uuid().optional(),
 ...
 */
export const SubscribtionUpdateBody = zod.object({
  type: zod.enum(["addsFree", "full"]).optional(),
  autoRenew: zod.boolean().optional()
});

export const SubscribtionUpdateResponse = zod
  .object({
    type: zod.enum(["addsFree", "full"]).optional(),
    autoRenew: zod.boolean().optional()
  })
 ...
 */
export const SubscribtionCancelImediatellyResponse = zod.unknown();
