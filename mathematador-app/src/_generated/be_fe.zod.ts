...
type CheckEmailResponse = zod.input<typeof CheckEmailResponse>;
type CheckEmailResponseOutput = zod.output<typeof CheckEmailResponse>;
...
type ConsentRecord = zod.input<typeof ConsentRecord>;
type ConsentRecordOutput = zod.output<typeof ConsentRecord>;
...
export const CredentialsUsername = zod.object({
  "username": zod.string().optional()
})

type CredentialsUsername = zod.input<typeof CredentialsUsername>;
type CredentialsUsernameOutput = zod.output<typeof CredentialsUsername>;
...
export const GameProgress = zod.object({
  ...
  "equippedCape": zod.union([zod.string().uuid(),zod.null()]).optional(),
  "equippedSuit": zod.union([zod.string().uuid(),zod.null()]).optional(),
  "equippedFlare": zod.union([zod.string().uuid(),zod.null()]).optional(),
...
export const GoogleIdToken = zod.object({
  "idToken": zod.string()
})

type GoogleIdToken = zod.input<typeof GoogleIdToken>;
type GoogleIdTokenOutput = zod.output<typeof GoogleIdToken>;
...
export const RegisterCredentials = zod.object({
  "email": zod.string().email()
}).and(zod.object({
  "password": zod.string()
})).and(zod.object({
...
type RegisterCredentials = zod.input<typeof RegisterCredentials>;
type RegisterCredentialsOutput = zod.output<typeof RegisterCredentials>;
...
type UserCheckEmailBodyOutput = zod.output<typeof UserCheckEmailBody>;
...
type UserConsentRecordBody = zod.input<typeof UserConsentRecordBody>;
type UserConsentRecordBodyOutput = zod.output<typeof UserConsentRecordBody>;
...
export const UserGoogleLoginBody = zod.object({
  "idToken": zod.string()
})

type UserGoogleLoginBody = zod.input<typeof UserGoogleLoginBody>;
type UserGoogleLoginBodyOutput = zod.output<typeof UserGoogleLoginBody>;
...
type UserSetting = zod.input<typeof UserSetting>;
type UserSettingOutput = zod.output<typeof UserSetting>;
...
export const UserSettingsGetHistoryParams = zod.object({
  "cursor": zod.string().optional(),
  "limit": zod.string().optional()
})

type UserSettingsGetHistoryParams = zod.input<typeof UserSettingsGetHistoryParams>;
type UserSettingsGetHistoryParamsOutput = zod.output<typeof UserSettingsGetHistoryParams>;
...
export const UserSettingsHistoryPage = zod.object({
...
type UserSettingsHistoryPage = zod.input<typeof UserSettingsHistoryPage>;
type UserSettingsHistoryPageOutput = zod.output<typeof UserSettingsHistoryPage>;
...
type UserSettingsUpdateBodyOutput = zod.output<typeof UserSettingsUpdateBody>;
