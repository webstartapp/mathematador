...
export type Operation = {
    ...
    symbol: string;
    description: string;
    getResult: (numbers: Exercise) => number;
...
export const operations: Operation[] = [
    {
        ...
        getResult: (numbers: Exercise) => numbers.reduce((acc, curr) => acc + curr, 0),
        timeCoeficient: 1,
        xpCoeficient: 1,
        resultIsFirst: false,
    },
    ...
    },
    {
        ...
        getResult: (numbers: Exercise) => numbers.reduce((acc, curr) => acc * curr, 1),
        timeCoeficient: 2,
        xpCoeficient: 2,
        resultIsFirst: false,
    },
