...
See the [root `CLAUDE.md`](../CLAUDE.md) first for monorepo-wide conventions, dev commands, and known gotchas — this file only covers what's specific to this workspace. In particular, see its "Orientation: locked to portrait, by design" section before laying out any new screen or minigame — landscape is a defensive fallback, not a design target.
